...
use app\Process\PushAmqpProcess;
use app\Process\MessageAmqpProcess;
...
class AppServer extends SwooleDistributedServer
{
    ...
    public function startProcess()
    {
        ...
        // 注册 email amqp 队列进程
        ProcessManager::getInstance()->addProcess(PushAmqpProcess::class,true);

        // 注册 message amqp 队列进程
        ProcessManager::getInstance()->addProcess(MessageAmqpProcess::class,true);
    }
